                ...
                response.json().then(function (data) {
                    if(data.response == "data") {
                        ...
                        if (data.errno == 2) {
                            ...
                            if (r == -1) {
                                term.classList.add("is-danger");
                                description.innerText = "Der Begriff \"" + term.innerText + "\" wurde leider nicht gefunden.jetzt hinzufügen <a href=\"https://dein-eiscafe.de/?add=" + term.innerText + "\">+</a>"
                                term.innerText = "Begriff nicht gefunden! jetzt hinzufügen <a href=\"https://dein-eiscafe.de/?add=" + term.innerText + "\">+</a>"
                            }
                        } else {
                            term.classList.add("is-danger");
